...
export default function RegisterPage() {
  const [form, setForm] = useState({ fullName: '', email: '', password: '', confirmPassword: '', role: 'floor' as Role, phone: '' })
  ...
  return (
    <Card className="shadow-xl border-0">
      ...
      <p className="text-center text-sm text-gray-500 mt-6">
        ...
        <Link href="/login" className="text-[#FF6357] font-medium hover:underline">Sign in</Link>
      </p>
    </Card>
  )
}
